...
fun Checkbox(
    ...
    if (component.type == ComponentType.Checkbox) {
        var localText by remember { mutableStateOf(component.content) }
        ...
        Row(modifier = modifier.fillMaxWidth()) {
            ...
            BasicTextField(
                ...
                modifier = Modifier
                    ...
                    .fillMaxWidth()
                    .onKeyEvent { event ->
                        if (event.type == KeyEventType.KeyUp && event.key == Key.Backspace && localText.isEmpty()) {
                            onDeleteCheckBox()
...
fun CheckboxPreview() {
    val component = ComponentViewData.empty(ComponentType.Checkbox).copy(
